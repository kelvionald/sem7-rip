<template>
    <Layout>
        <div style="padding-left: 10px;padding-right: 10px;">
            <div class="tabs">
                <a @click="setModeUsers" :style="{color: mode == MODE_USERS ? 'black' : 'var(--link-color)'}">Люди</a>
                <a @click="setModePosts" :style="{color: mode == MODE_POSTS ? 'black' : 'var(--link-color)'}">Посты</a>
            </div>
